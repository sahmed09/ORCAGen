...
int wmain() {
    ...
    const std::wstring targetExe = LR"(C:\Users\User\Documents\MalwareAnalysis\ClipboardLogger\Debug\ClipboardLoggerPOC.exe)";
    ...
    const std::wstring dllRel = L"..\\Debug\\AntiClipboardLoggerHook.dll";
