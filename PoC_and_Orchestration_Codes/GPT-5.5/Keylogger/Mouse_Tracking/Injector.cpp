...
int wmain() {
    ...
    const std::wstring targetExe = LR"(C:\Users\User\Documents\MalwareAnalysis\ClipboardLogger\Debug\MouseTrackingPOC.exe)";
    ...
    const std::wstring dllRel = L"..\\Debug\\AntiMouseTrackingHook.dll";
