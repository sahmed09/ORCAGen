...
int wmain() {
    ...
    const std::wstring targetExe = LR"(C:\Users\User\Documents\MalwareAnalysis\ClipboardLogger\Debug\FileRenamingPOC.exe)";
    ...
    const std::wstring dllRel = L"..\\Debug\\AntiFileRenamingHook.dll";
