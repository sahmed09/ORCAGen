...
int wmain() {
    ...
    const std::wstring targetExe = LR"(C:\Users\User\Documents\MalwareAnalysis\ClipboardLogger\Debug\KeyboardHookingPOC.exe)";
    ...
    const std::wstring dllRel = L"..\\Debug\\AntiKeyboardHookingHook.dll";
