...
int wmain() {
    ...
    const std::wstring targetExe = LR"(C:\Users\User\Documents\MalwareAnalysis\ClipboardLogger\Debug\ScreenLoggingPOC.exe)";
    ...
    const std::wstring dllRel = L"..\\Debug\\AntiScreenLoggingHook.dll";
