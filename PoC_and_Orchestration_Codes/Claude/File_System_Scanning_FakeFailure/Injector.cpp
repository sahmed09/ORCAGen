...
int wmain() {
    ...
    const std::wstring targetExe = LR"(C:\Users\User\Documents\MalwareAnalysis\ClipboardLogger\Debug\FileScannerPOC.exe)";
    ...
    const std::wstring dllRel = L"..\\Debug\\AntiFileScannerHook.dll";
