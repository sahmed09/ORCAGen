...
int wmain() {
    ...
    const std::wstring targetExe = LR"(C:\Users\User\Documents\MalwareAnalysis\ClipboardLogger\Debug\RegistryMiningPOC.exe)";
    ...
    const std::wstring dllRel = L"..\\Debug\\AntiRegistryMiningHook.dll";
